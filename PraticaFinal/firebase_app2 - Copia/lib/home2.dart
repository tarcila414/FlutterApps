                        ...
                        actions: <Widget>[
                          ElevatedButton(
                              ...
                              onPressed: (){
                                ...
                                ruaInputController.clear();
                                bairroInputController.clear();
                                cidadeInputController.clear();
                              },
                              child: Text(
                                "Cancelar",
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Slidable(
            ...
            child: ListTile(
              leading: Image.network(item["img"] != "" ? item["img"] : 'https://firebasestorage.googleapis.com/v0/b/projeto-exemplo-18a77.appspot.com/o/images%2Fperfil_img.png?alt=media&token=d3a378d8-6242-4b9a-bbdc-283ea7da23d0',
                 width: 50,
                 height: 50,),
            ...
            return Slidable(
              ...
              child: ListTile(
                  leading: ConstrainedBox(
                    ...
                    child: ElevatedButton(
                    style: ElevatedButton.styleFrom(primary: Colors.white24, padding: EdgeInsets.all(0.0) ),
                    child: Image.network(item["img"] != "" ? item["img"] : 'https://firebasestorage.googleapis.com/v0/b/projeto-exemplo-18a77.appspot.com/o/images%2Fperfil_img.png?alt=media&token=d3a378d8-6242-4b9a-bbdc-283ea7da23d0',
                      width: 50,
                      height: 50,
                    ),
                    onPressed: () {
    ...
    task.snapshotEvents.listen((snapShot) {
      if(snapShot.state == TaskState.success) {
         snapShot.ref.getDownloadURL()
            .then(
                (imageUrl) => {
                  writeImageUrlToFireStore(imageUrl, item),
                }
            );
      }
    });
