...
import 'home.dart';
import 'wordZGame.dart';

class wordAPage extends StatefulWidget {
  @override
  _wordAPageState createState() => _wordAPageState();
}

class _wordAPageState extends State<wordAPage> {
  // VARIAVEIS
      ...
      actions: <Widget>[
        ...
        TextButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => wordZPage()),
              );
            },
            child: Text("  Próximo  "))
      ],
